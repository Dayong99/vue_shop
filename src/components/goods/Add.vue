...
<!--      步骤条区域-->
<!--      :active="activeIndex -0" ----将字符串 :active="activeIndex" 转换成数值-->
  ...
  export default {
    ...
    methods: {
      ...
      tabClicked() {
        ...
        // 如果 this.activeIndex = '1', 证明选中的是动态参数面板
      ...
      handleRemove(file) {
        ...
        // 3.调用数组的 splice 方法,把图片信息对象从 pics 中移除
      ...
      add() {
        ...
        this.$refs.addFormRef.validate(valid => {
          ...
          // 发起请求,添加商品
          // 商品名称必须是唯一的
          this.axios.post('goods', this.addForm).then(
            res => {
